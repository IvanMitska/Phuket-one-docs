...
const CONTENT = {
        ...
        content: `
                ...
                <div class="feature-list">
                    <div class="feature-item feature-expandable" onclick="toggleFeatureExpand(this)">
                        ...
                        <div class="feature-text">
                            <h4>Аренда транспорта</h4>
                            <p>Скутеры, мотоциклы, автомобили, внедорожники с прозрачным ценообразованием</p>
                        </div>
                        ...
                        <div class="feature-expand-content">
                            <div class="feature-details">
                                <h5>Функционал:</h5>
                                <ul>
                                    <li>Каталог транспорта с фильтрами (тип, цена, район)</li>
                                    <li>Онлайн-бронирование с выбором дат</li>
                                    <li>Калькулятор стоимости аренды</li>
                                    <li>Карта расположения пунктов выдачи</li>
                                    <li>Отзывы и рейтинги арендодателей</li>
                                </ul>
                                <p><strong>Типы транспорта:</strong> Скутеры (125-150cc), мотоциклы, седаны, внедорожники, минивэны</p>
                            </div>
                        </div>
                    </div>
                    <div class="feature-item feature-expandable" onclick="toggleFeatureExpand(this)">
                        ...
                        <div class="feature-text">
                            <h4>Жильё</h4>
                            <p>Виллы, апартаменты, отели с прямым бронированием</p>
                        </div>
                        <span class="feature-arrow">▼</span>
                        <div class="feature-expand-content">
                            <div class="feature-details">
                                <h5>Функционал:</h5>
                                <ul>
                                    <li>Поиск по районам Пхукета с картой</li>
                                    <li>Фильтры: цена, количество спален, удобства</li>
                                    <li>Галереи фотографий и виртуальные туры</li>
                                    <li>Прямое бронирование без посредников</li>
                                    <li>Связь с владельцем через чат</li>
                                </ul>
                                <p><strong>Типы жилья:</strong> Виллы, кондо, апартаменты, гестхаусы, отели</p>
                            </div>
                        </div>
                    </div>
                    <div class="feature-item feature-expandable" onclick="toggleFeatureExpand(this)">
                        ...
                        <div class="feature-text">
                            ...
                            <p>Экскурсии по островам, мероприятия, достопримечательности</p>
                        </div>
                        <span class="feature-arrow">▼</span>
                        <div class="feature-expand-content">
                            <div class="feature-details">
                                <h5>Функционал:</h5>
                                <ul>
                                    <li>Каталог экскурсий с описанием и фото</li>
                                    <li>Бронирование на конкретную дату</li>
                                    <li>Групповые и индивидуальные туры</li>
                                    <li>Трансфер из отеля включён</li>
                                    <li>Электронные билеты в приложении</li>
                                </ul>
                                <p><strong>Популярные:</strong> Острова Пхи-Пхи, Джеймс Бонд, Симиланы, Big Buddha, Old Town</p>
                            </div>
                        </div>
                    </div>
                    <div class="feature-item feature-expandable" onclick="toggleFeatureExpand(this)">
                        ...
                        <div class="feature-text">
                            <h4>ИИ-помощник</h4>
                            <p>Умный помощник для туристов 24/7</p>
                        </div>
                        <span class="feature-arrow">▼</span>
                        <div class="feature-expand-content">
                            <div class="feature-details">
                                <h5>Возможности:</h5>
                                <ul>
                                    <li>Ответы на вопросы о Пхукете 24/7</li>
                                    <li>Рекомендации ресторанов, пляжей, достопримечательностей</li>
                                    <li>Помощь с бронированием</li>
                                    <li>Перевод на тайский язык</li>
                                    <li>Экстренная помощь и контакты служб</li>
                                </ul>
                                <p><strong>Технология:</strong> GPT-4 с fine-tuning на данных о Пхукете</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="section">
                ...
                <div class="cards-grid">
                    <div class="card" onclick="navigateTo('ios-technical')">
                        <span class="card-icon">🍎</span>
                        <h3 class="card-title">iOS / SwiftUI</h3>
                        <p class="card-description">Нативное iOS приложение на SwiftUI, архитектура MVVM и Swift Concurrency</p>
                        <span class="card-platform ios">iOS 17+</span>
                    </div>
                    <div class="card" onclick="navigateTo('android-arch')">
                        <span class="card-icon">🤖</span>
                        <h3 class="card-title">Android / Kotlin</h3>
                        <p class="card-description">Нативное Android приложение с Jetpack Compose, Clean Architecture и Kotlin Coroutines</p>
                        <span class="card-platform android">Android 8.0+</span>
                    </div>
                    <div class="card" onclick="navigateTo('web-arch')">
                        <span class="card-icon">🌐</span>
                        <h3 class="card-title">Web / Next.js</h3>
                        <p class="card-description">React SPA с Next.js 14, TypeScript, Tailwind CSS и Server Components</p>
                        <span class="card-platform web">Все браузеры</span>
                    </div>
                </div>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Нативный iOS с MVVM + Repository</td>
                            </tr>
                            <tr>
                                <td><strong>Android</strong></td>
                                <td>Kotlin 1.9, Jetpack Compose</td>
                                <td>Нативный Android с Clean Architecture</td>
                            </tr>
                            <tr>
                                <td><strong>Бэкенд</strong></td>
                                <td>Python 3.13, FastAPI</td>
                                <td>Асинхронный REST API с Uvicorn</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><strong>Кеш</strong></td>
                                <td>Redis 7</td>
                                <td>Сессии, ограничение частоты, кеширование</td>
                            </tr>
                            <tr>
                                <td><strong>Облако</strong></td>
                                <td>AWS (Сингапур)</td>
    ...
    // ========================================================================
    prd: {
        title: 'Требования к продукту',
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Начало работы', 'PRD'],
        description: 'Документ требований к продукту Phuket App',
        content: `
            <div class="section">
                <h2 class="section-title">1. Постановка проблемы</h2>
                <p>Туристы, посещающие Пхукет, сталкиваются с рядом проблем:</p>
                <ul>
                    <li><strong>Фрагментированные сервисы</strong> - нужно 5-10 разных приложений для транспорта, жилья, туров</li>
                    <li><strong>Языковой барьер</strong> - местные сервисы не поддерживают русский/английский</li>
                    <li><strong>Непрозрачность цен</strong> - нет единого сравнения цен</li>
                    <li><strong>Наценки посредников</strong> - высокие комиссии агентств</li>
                    <li><strong>Нет персонализации</strong> - нет программы лояльности для постоянных гостей</li>
                </ul>
            </div>

            <div class="section">
                <h2 class="section-title">2. Целевая аудитория</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>Русскоязычные туристы</td>
                                <td>Россия, СНГ, экспаты на Пхукете</td>
                                <td>40%</td>
                            </tr>
                            <tr>
                                <td>Европейские туристы</td>
                                <td>Великобритания, Германия, Франция, Скандинавия</td>
                                <td>25%</td>
                            </tr>
                            <tr>
                                <td>Китайские туристы</td>
                                <td>Материковый Китай, Гонконг, Тайвань</td>
                                <td>20%</td>
                            </tr>
                            <tr>
                                <td>Цифровые кочевники</td>
                                <td>Удалённые работники, долгосрочное проживание</td>
                                <td>10%</td>
                            </tr>
                            <tr>
                                <td>Другие</td>
                                <td>Австралия, США, другие страны</td>
                                <td>5%</td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="section">
                <h2 class="section-title">3. Основные функции</h2>

                <h3 class="section-subtitle">3.1 Аутентификация (P0)</h3>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr><td>AUTH-001</td><td>Регистрация по email/паролю</td><td>P0</td></tr>
                            <tr><td>AUTH-002</td><td>Вход в систему</td><td>P0</td></tr>
                            <tr><td>AUTH-003</td><td>Сброс пароля через email</td><td>P0</td></tr>
                            <tr><td>AUTH-004</td><td>Вход через соцсети (Google, Apple, Facebook)</td><td>P1</td></tr>
                            <tr><td>AUTH-005</td><td>Двухфакторная аутентификация</td><td>P2</td></tr>
                            <tr><td>AUTH-006</td><td>Биометрический вход (Face ID, Touch ID)</td><td>P1</td></tr>
                        </tbody>
                    </table>
                </div>

                <h3 class="section-subtitle">3.2 Аренда транспорта (P0)</h3>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr><td>TRANS-001</td><td>Каталог транспорта с фильтрами</td><td>P0</td></tr>
                            <tr><td>TRANS-002</td><td>Фильтр по типу (скутер, мотоцикл, авто, внедорожник)</td><td>P0</td></tr>
                            <tr><td>TRANS-003</td><td>Фильтр по диапазону цен</td><td>P0</td></tr>
                            <tr><td>TRANS-004</td><td>Карточка транспорта (фото, характеристики, отзывы)</td><td>P0</td></tr>
                            <tr><td>TRANS-005</td><td>Бронирование на конкретные даты</td><td>P0</td></tr>
                            <tr><td>TRANS-006</td><td>Отображение на карте</td><td>P1</td></tr>
                        </tbody>
                    </table>
                </div>

                <h3 class="section-subtitle">3.3 ИИ-ассистент (P1)</h3>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr><td>AI-001</td><td>Интерфейс чата</td><td>P1</td></tr>
                            <tr><td>AI-002</td><td>Местные знания (места, обычаи)</td><td>P1</td></tr>
                            <tr><td>AI-003</td><td>Мультиязычность (RU, EN, ZH)</td><td>P1</td></tr>
                            <tr><td>AI-004</td><td>Рекомендации по бронированию</td><td>P2</td></tr>
                            <tr><td>AI-005</td><td>Экстренная помощь</td><td>P1</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="section">
                <h2 class="section-title">4. Программа лояльности</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                                <th>Уровень</th>
                                <th>Необходимо баллов</th>
                                <th>Преимущества</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>0</td>
                                <td>Базовый доступ, 200 приветственных баллов</td>
                            </tr>
                            <tr>
                                <td><strong>Серебро</strong></td>
                                <td>1 000</td>
                                <td>Скидка 5%, приоритетная поддержка</td>
                            </tr>
                            <tr>
                                <td><strong>Золото</strong></td>
                                <td>5 000</td>
                                <td>Скидка 10%, бесплатные апгрейды</td>
                            </tr>
                            <tr>
                                <td><strong>Платина</strong></td>
                                <td>15 000</td>
                                <td>Скидка 15%, VIP-поддержка, эксклюзивные предложения</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    discovery: {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Начало работы', 'Исследование'],
        description: 'Исследование рынка и результаты product discovery',
        content: `
            <div class="section">
                <h2 class="section-title">1. Обзор рынка</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
            ...
            <div class="section">
                <h2 class="section-title">2. Анализ конкурентов</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Большая база, удобство</td>
                                <td>Нет жилья/туров</td>
                            </tr>
                            <tr>
                                <td><strong>Agoda</strong></td>
                                <td>Отели</td>
                                <td>Огромный каталог</td>
                                <td>Только жильё</td>
                            </tr>
                            <tr>
                                <td><strong>Klook</strong></td>
                                <td>Туры, активности</td>
                                <td>Много экскурсий</td>
                                <td>Нет транспорта/жилья</td>
                            </tr>
                            <tr>
                                <td><strong>Traveloka</strong></td>
                                <td>Комплексный</td>
                                <td>Много сервисов</td>
                                <td>Сложный интерфейс</td>
                            </tr>
                            <tr>
                                <td><strong>Местные агенты</strong></td>
                                <td>Всё</td>
                                <td>Личный подход</td>
                                <td>Высокие цены, нет приложения</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="section">
                <h2 class="section-title">3. SWOT-анализ</h2>
...
|  - Русскоязычный ИИ            |  |  - Нет истории отзывов         |
...
|        ВОЗМОЖНОСТИ             |  |           УГРОЗЫ               |
|                                |  |                                |
|  - Рост туризма                |  |  - Расширение Grab/Agoda       |
|  - Цифровизация                |  |  - Местные конкуренты          |
|  - Недообслуженный RU рынок    |  |  - Экономический спад          |
|  - B2B партнёрства             |  |  - Регуляторные риски          |
|  - Расширение на Самуи         |  |                                |
+--------------------------------+  +--------------------------------+
                    </pre>
                </div>
            ...
            <div class="section">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-label">TAM (туризм Таиланда)</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">$2B</div>
                        <div class="stat-label">SAM (цифровой Пхукет)</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value">$50M</div>
                        <div class="stat-label">SOM (цель 3-й год)</div>
                    </div>
                    <div class="stat-card">
    ...
    'system-design': {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Архитектура', 'Дизайн системы'],
        description: 'Высокоуровневая архитектура системы и компоненты',
        content: `
            <div class="section">
...
+------------------------------------------------------------------------------+
            ...
            <div class="section">
                <h2 class="section-title">2. Компоненты</h2>

                <h3 class="section-subtitle">2.1 Мобильные приложения</h3>
                <div class="table-wrapper">
                    <table class="comparison-table">
                        <thead>
                            <tr>
                                <th class="col-aspect">Аспект</th>
                ...
                <h3 class="section-subtitle">2.2 Бэкенд</h3>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Кеш</td>
                                <td>Redis 7</td>
                                <td>Сессии, ограничение частоты</td>
                            </tr>
                            <tr>
                                <td>Хранилище</td>
                                <td>AWS S3</td>
                                <td>Изображения, документы</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="section">
                <h2 class="section-title">3. Внешние сервисы</h2>
                <div class="cards-grid">
                    <div class="card">
                        <span class="card-icon">🤖</span>
                        <h3 class="card-title">OpenAI</h3>
                        <p class="card-description">GPT-4 для чат-функционала ИИ-ассистента</p>
                    </div>
                    <div class="card">
                        <span class="card-icon">💳</span>
                        <h3 class="card-title">Stripe</h3>
                        <p class="card-description">Обработка платежей за бронирования</p>
                    </div>
                    <div class="card">
                        <span class="card-icon">🔔</span>
                        <h3 class="card-title">Firebase</h3>
                        <p class="card-description">Push-уведомления</p>
                    </div>
                    <div class="card">
                        <span class="card-icon">📧</span>
                        <h3 class="card-title">SendGrid</h3>
                        <p class="card-description">Транзакционные email-письма</p>
                    </div>
                    <div class="card">
                        <span class="card-icon">🌤️</span>
                        <h3 class="card-title">OpenWeather</h3>
                        <p class="card-description">Прогноз погоды для Пхукета</p>
                    </div>
                    <div class="card">
                        <span class="card-icon">📊</span>
                        <h3 class="card-title">Sentry</h3>
                        <p class="card-description">Мониторинг и отслеживание ошибок</p>
                    </div>
                </div>
            </div>
        `
    ...
    'solution-arch': {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Архитектура', 'Solution Architecture'],
        description: 'Диаграммы модели C4 и архитектурное видение',
        content: `
            <div class="section">
                <h2 class="section-title">1. Архитектурное видение</h2>
                <p>Решение построено на следующих принципах:</p>
                <div class="feature-list">
                    <div class="feature-item">
                        <span class="feature-icon">📱</span>
                        <div class="feature-text">
                            <h4>Mobile-first</h4>
                            <p>Основной фокус на мобильных приложениях</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">🔌</span>
                        <div class="feature-text">
                            <h4>API-centric</h4>
                            <p>Единый API для всех клиентов</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">☁️</span>
                        <div class="feature-text">
                            <h4>Cloud-native</h4>
                            <p>Готов к развёртыванию в облаке</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">🔒</span>
                        <div class="feature-text">
                            ...
                            <p>Безопасность на всех уровнях</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                <h2 class="section-title">2. Ключевые решения</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Нативный UI, лучший UX</td>
                            </tr>
                            <tr>
                                <td>Backend Framework</td>
                                <td>FastAPI</td>
                                <td>Высокая производительность, async/await</td>
                            </tr>
                            <tr>
                                <td>База данных</td>
                                <td>PostgreSQL</td>
                                <td>Надёжность, поддержка JSON, масштабируемость</td>
                            </tr>
                            <tr>
                                <td>Кеш</td>
                                <td>Redis</td>
                                <td>Быстрый кеш, rate limiting</td>
                            </tr>
                            <tr>
                                <td>Облако</td>
                                <td>AWS</td>
                                <td>Экосистема, регион Сингапур</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="section">
                <h2 class="section-title">3. Диаграмма контейнеров (C4 Level 2)</h2>
                <div class="diagram-block">
                    <pre>
+-----------------------------------------------------------------------------+
|                          CONTAINER DIAGRAM                                   |
...
+------------------------------------------------------------------------------+
            ...
            <div class="section">
                <h2 class="section-title">4. Архитектура безопасности</h2>
                <div class="callout info">
                    <span class="callout-icon">🔐</span>
                    <div class="callout-content">
                        <div class="callout-title">Уровни безопасности</div>
                        <div class="callout-text">Многоуровневая защита системы от периметра до базы данных</div>
                    </div>
                </div>
                <ul>
                    <li><strong>Периметр</strong>: CloudFlare WAF, защита от DDoS</li>
                    <li><strong>Транспорт</strong>: TLS 1.3, SSL certificate pinning</li>
                    <li><strong>Приложение</strong>: JWT токены, rate limiting, валидация ввода</li>
                    <li><strong>Данные</strong>: Шифрование в покое, безопасное хранение ключей</li>
                    <li><strong>Мобильные</strong>: Keychain/EncryptedPrefs, биометрическая аутентификация</li>
                </ul>
            </div>
        `
    },
    ...
    'software-arch': {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Архитектура', 'Software Architecture'],
        description: 'Паттерны и принципы программной архитектуры',
        content: `
            <div class="section">
                <h2 class="section-title">1. Архитектурный стиль</h2>
                <p>Phuket App использует <strong>клиент-серверную архитектуру</strong> с RESTful API:</p>
                <div class="diagram-block">
                    <pre>
+-----------------------------------------------------------------------------+
...
+------------------------------------------------------------------------------+
            ...
            <div class="section">
                <h2 class="section-title">2. Ключевые принципы</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Чёткое разделение ответственности</td>
                                <td>Слои: Presentation, API, Data</td>
                            </tr>
                            <tr>
                                <td><strong>Single Responsibility</strong></td>
                                <td>Каждый модуль делает одно дело</td>
                                <td>Модульность по фичам</td>
                            </tr>
                            <tr>
                                <td><strong>Dependency Inversion</strong></td>
                                <td>Зависимость от абстракций</td>
                                <td>Протоколы/Интерфейсы</td>
                            </tr>
                            <tr>
                                <td><strong>Open/Closed</strong></td>
                                <td>Открыт для расширения, закрыт для модификации</td>
                                <td>Plugin-подобная архитектура</td>
                            </tr>
                            <tr>
                                <td><strong>DRY</strong></td>
                                <td>Не повторяйся</td>
                                <td>Общие компоненты, утилиты</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="section">
                <h2 class="section-title">3. Структура модулей</h2>
...
|   +-- ai_chat/
    ...
    'ios-technical': {
        ...
        icon: null,
        platform: 'ios',
        breadcrumb: ['Документация', 'iOS / SwiftUI', 'Технический дизайн'],
        description: 'Детали технической реализации iOS',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
            quick: `
            <div class="section">
                <h2 class="section-title">Технологический стек iOS</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
            ...
            <div class="section">
                <h2 class="section-title">Ключевые паттерны</h2>
                <div class="cards-grid">
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        <span class="card-icon">📱</span>
                        <h3 class="card-title">MVVM</h3>
                        <p class="card-description">@StateObject + @Published для reactive UI</p>
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Пример ViewModel:</h4>
                                <pre>@MainActor
class VehiclesViewModel: ObservableObject {
    ...
    func loadVehicles() async {
        ...
        isLoading = false
                                ...
                                <p><strong>Связь:</strong> View наблюдает за @Published свойствами через @StateObject</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        ...
                        <p class="card-description">Абстракция data source для тестируемости</p>
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Структура:</h4>
...
class VehicleRepository: VehicleRepositoryProtocol {
    ...
    private let cache: CacheManager
                                ...
                                <p><strong>Преимущества:</strong> Легко мокать для тестов, единая точка доступа к данным</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        ...
                        <p class="card-description">Custom DI для инъекции зависимостей</p>
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Реализация:</h4>
                                <pre>@MainActor
class DependencyContainer {
    ...
    lazy var authService = AuthService(api: apiClient)
                                ...
                                <p><strong>Использование:</strong> @Environment для внедрения в SwiftUI views</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        ...
                        <p class="card-description">Certificate pinning для безопасности</p>
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Конфигурация:</h4>
    ...
    func urlSession(_ session: URLSession,
        ...
        // Verify certificate against pinned hash
                                ...
                                <p><strong>Защита:</strong> Предотвращает MITM атаки, проверяет сертификат сервера</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            // ═══════════════════════════════════════════════════════════════════
            // MEDIUM - Средний уровень детализации
            // ═══════════════════════════════════════════════════════════════════
            medium: `
            <div class="section">
...
│                    ▼                                                         │
│   VIEWMODEL LAYER                                                           │
│   ├── HomeViewModel, TransportViewModel                                     │
│   └── @Published state, isLoading, error                                    │
│                    │                                                         │
...
│                    ▼                                                         │
│   CORE LAYER                                                                │
│   ├── NetworkManager (SSL Pinning, async/await)                             │
│   ├── KeychainManager (Token Storage)                                       │
│   └── CacheManager (API Cache, TTL Policy)                                  │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
                    </pre>
                </div>
...
│   └── AIChat/
├── Core/
│   ├── Network/                     # URLSession, SSL Pinning
...
<span class="keyword">final class</span> <span class="class-name">KeychainTokenManager</span>: <span class="class-name">TokenManagerProtocol</span> {
    ...
    'ios-adr': {
        ...
        icon: null,
        platform: 'ios',
        breadcrumb: ['Документация', 'iOS / SwiftUI', 'ADR'],
        description: 'Записи архитектурных решений для iOS',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
            quick: `
            <div class="section">
                <h2 class="section-title">Архитектурные решения iOS</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
            ...
            <div class="section">
                <h2 class="section-title">Ключевые последствия</h2>
                <ul>
                    <li>Минимум iOS 17+ (отсекает ~10% устройств)</li>
                    <li>Android требует отдельной разработки (Kotlin)</li>
                    <li>Команда должна знать Swift + SwiftUI</li>
                    <li>Нативная интеграция с Apple Maps</li>
                </ul>
            </div>
            `,
...
NetworkManager / CacheManager
    ...
    // ========================================================================
    'ios-rfc': {
        title: 'RFC (Предложения)',
        icon: null,
        platform: 'ios',
        breadcrumb: ['Документация', 'iOS / SwiftUI', 'RFC'],
        description: 'Request for Comments - предлагаемые функции для iOS',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
            quick: `
            <div class="section">
                <h2 class="section-title">Предлагаемые функции iOS</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
    ...
    'android-arch': {
        ...
        icon: null,
        platform: 'android',
        breadcrumb: ['Документация', 'Android / Kotlin', 'Архитектура'],
        description: 'Обзор архитектуры Android приложения',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
            quick: `
            <div class="section">
                <h2 class="section-title">Технологический стек Android</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
            ...
            <div class="section">
                ...
                <div class="cards-grid">
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        ...
                        <p class="card-description">Presentation → Domain → Data layers</p>
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Структура слоёв:</h4>
...
├── remote/     # API calls
├── local/      # Room DB
└── repository/ # Repository implementations</pre>
                                <p><strong>Принцип:</strong> Зависимости направлены внутрь, domain не знает о data</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
    ...
    fun onEvent(event: UiEvent) {
        when (event) {
            ...
            is UiEvent.SelectVehicle -> selectVehicle(event.id)
                                ...
                                <p><strong>Flow:</strong> UI Event → ViewModel → State Update → UI Recompose</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
...
:feature
├── :feature:transport  # Vehicle rental
├── :feature:booking    # Booking flow
├── :feature:profile    # User profile
└── :feature:auth       # Authentication</pre>
                                <p><strong>Преимущества:</strong> Параллельная сборка, изоляция, переиспользование</p>
                            </div>
                        </div>
                    </div>
                </div>
...
│                    ▼                                                         │
│   DOMAIN LAYER                                                              │
│   ├── UseCases: GetVehiclesUseCase, CreateBookingUseCase                    │
...
PhuketApp/
├── app/                    # Main application module
├── core/                   # Core modules (network, database, security)
├── domain/                 # Domain layer (models, usecases, repositories)
├── data/                   # Data layer (implementations)
├── feature/                # Feature modules (home, transport, tours...)
└── designsystem/           # Design system (theme, components)
                    </pre>
                </div>
            </div>
            `,
...
- Foldables: Supported
    ...
    'android-technical': {
        ...
        icon: null,
        platform: 'android',
        breadcrumb: ['Документация', 'Android / Kotlin', 'Технический дизайн'],
        description: 'Детали технической реализации Android',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
...
<span class="keyword">object</span> <span class="class-name">NetworkModule</span> {
    ...
    'android-adr': {
        ...
        icon: null,
        platform: 'android',
        breadcrumb: ['Документация', 'Android / Kotlin', 'ADR'],
        description: 'Записи архитектурных решений для Android',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
    ...
    'android-rfc': {
        ...
        icon: null,
        platform: 'android',
        breadcrumb: ['Документация', 'Android / Kotlin', 'RFC'],
        description: 'Request for Comments - предлагаемые функции для Android',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
...
+---------------+              |     Dec 18     ฿1,500      |
    ...
    'web-arch': {
        ...
        icon: null,
        platform: 'web',
        breadcrumb: ['Документация', 'Web / Next.js', 'Архитектура'],
        description: 'Обзор архитектуры Web приложения',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
...
└── layout.tsx        # Root Layout</pre>
                                <p><strong>Преимущества:</strong> Автоматический code-splitting, nested layouts, loading/error states</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
                        ...
                        <div class="card-expand-content">
                            <div class="expand-details">
                                <h4>Пример Server Component:</h4>
                                <pre>// app/transport/page.tsx
export default async function Page() {
  const vehicles = await db.vehicle.findMany()
  return &lt;VehicleList data={vehicles} /&gt;
}</pre>
                                <p><strong>Преимущества:</strong> Zero JS bundle для компонентов, прямой доступ к БД, streaming SSR</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
...
theme: {
  ...
  fontFamily: {
    sans: ['Inter', 'sans-serif']
                                ...
                                <p><strong>Компоненты:</strong> shadcn/ui + Radix UI для accessible UI</p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-expandable" onclick="toggleCardExpand(this)">
...
└── types/           # TypeScript types</pre>
                                <p><strong>Принцип:</strong> Каждая фича изолирована и может быть удалена без влияния на другие</p>
                            </div>
                        </div>
                    </div>
                </div>
...
│   ├── app/                                                                  │
│   │   ├── (auth)/login, register                                           │
│   │   ├── (main)/transport, accommodation, tours                           │
│   │   └── api/                                                              │
│                    │                                                         │
│                    │ Server Components                                       │
│                    ▼                                                         │
│   FEATURES                                                                  │
│   ├── transport/ (components, hooks, api)                                   │
│   ├── accommodation/                                                        │
│   └── booking/                                                              │
│                    │                                                         │
│                    │ React Query                                             │
...
└── styles/                   # Global styles
            ...
            // ═══════════════════════════════════════════════════════════════════
            // FULL - Полная информация (ОБШИРНАЯ ДОКУМЕНТАЦИЯ)
            // ═══════════════════════════════════════════════════════════════════
            full: `
            <div class="section">
                ...
                <div class="toc-block">
                    <ol>
                        ...
                        <li><a href="#architecture">Архитектура системы</a></li>
                        <li><a href="#project-structure">Структура проекта</a></li>
                        <li><a href="#routing">Маршрутизация (App Router)</a></li>
                        <li><a href="#components">Компоненты и паттерны</a></li>
                        <li><a href="#state-management">Управление состоянием</a></li>
                        <li><a href="#data-fetching">Получение данных</a></li>
                        <li><a href="#authentication">Аутентификация</a></li>
                        <li><a href="#api-routes">API Routes</a></li>
                        <li><a href="#database">База данных (Prisma)</a></li>
                        <li><a href="#forms">Формы и валидация</a></li>
                        <li><a href="#payments">Интеграция платежей</a></li>
                        <li><a href="#maps">Карты и геолокация</a></li>
                        <li><a href="#file-upload">Загрузка файлов</a></li>
                        <li><a href="#email">Email уведомления</a></li>
                        ...
                        <li><a href="#deployment">Деплой и CI/CD</a></li>
            ...
            <div class="section" id="tech-stack">
                <h2 class="section-title">1. Технологический стек</h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>TypeScript</td>
                                <td>5.3+</td>
                                <td>Strict mode, ESLint интеграция</td>
                            </tr>
                            <tr>
                                <td><strong>Runtime</strong></td>
                                <td>Node.js</td>
                                <td>20 LTS</td>
                                <td>Edge Runtime для middleware</td>
                            </tr>
                            <tr>
  ...
  "devDependencies": {
    ...
    "lint-staged": "15.2.0"
            ...
            <div class="section" id="architecture">
                <h2 class="section-title">2. Архитектура системы</h2>
                <div class="diagram-block">
                    <pre>
+-----------------------------------------------------------------------------+
|                         WEB ARCHITECTURE (Next.js 14)                        |
...
|  |  │   ├── hooks/                # useVehicles, useBookVehicle         |  |
|  |  │   ├── api/                  # API functions                        |  |
...
│  ┌─────────────────────────────────────────────────────────────┐    │
│  │                      PAYMENTS (Stripe)                       │    │
│  │  • Checkout Sessions    • Connect (Payouts)                  │    │
│  │  • Webhooks: payment_intent, checkout.session, refund        │    │
│  └─────────────────────────────────────────────────────────────┘    │
│                                                                      │
│  ┌─────────────────────────────────────────────────────────────┐    │
│  │                       MAPS (Mapbox)                          │    │
│  │  • GL JS Map Component  • Geocoding  • Directions API        │    │
│  └─────────────────────────────────────────────────────────────┘    │
│                                                                      │
│  ┌─────────────────────────────────────────────────────────────┐    │
│  │                   FILE STORAGE (Cloudflare R2)               │    │
│  │  • Images Upload  • Videos Upload  • Signed URLs             │    │
│  └─────────────────────────────────────────────────────────────┘    │
│                                                                      │
│  ┌───────────────────────────┐  ┌───────────────────────────┐       │
...
│  │  • Error tracking         │  │  • Currency rates API     │       │
│  │  • Performance traces     │  │  • Weather data API       │       │
│  └───────────────────────────┘  └───────────────────────────┘       │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
                    </pre>
...
│  │   │ • Home         │   │ • /api/auth    │   │ • JS/CSS       │       │  │
│  │   │ • Properties   │   │ • /api/props   │   │ • Images       │       │  │
│  │   │ • Tours        │   │ • /api/booking │   │ • Fonts        │       │  │
│  │   └────────────────┘   └───────┬────────┘   └────────────────┘       │  │
│  └────────────────────────────────┼──────────────────────────────────────┘  │
└───────────────────────────────────┼──────────────────────────────────────────┘
                                    │
...
│   (Neon/Supabase)   │  │   (File Storage)    │  │  Stripe, Mapbox     │
│   Users, Properties │  │   images/, videos/  │  │  Resend, PostHog    │
│   Bookings, Reviews │  │                     │  │  Sentry, Currency   │
└─────────────────────┘  └─────────────────────┘  └─────────────────────┘
                    </pre>
                </div>
            </div>
  ...
  <span class="keyword">return</span> (
    &lt;div className=<span class="string">"min-h-screen flex items-center justify-center"</span>&gt;
      &lt;div className=<span class="string">"text-center space-y-4"</span>&gt;
        &lt;h1 className=<span class="string">"text-4xl font-bold"</span>&gt;Что-то пошло не так&lt;/h1&gt;
...
<span class="keyword">export class</span> <span class="class-name">AuthenticationError</span> <span class="keyword">extends</span> <span class="class-name">AppError</span> {
  <span class="keyword">constructor</span>(message = <span class="string">'Требуется авторизация'</span>) {
...
<span class="keyword">export class</span> <span class="class-name">ForbiddenError</span> <span class="keyword">extends</span> <span class="class-name">AppError</span> {
  <span class="keyword">constructor</span>(message = <span class="string">'Доступ запрещен'</span>) {
...
<span class="keyword">export class</span> <span class="class-name">NotFoundError</span> <span class="keyword">extends</span> <span class="class-name">AppError</span> {
  <span class="keyword">constructor</span>(resource: <span class="class-name">string</span>) {
    <span class="keyword">super</span>(<span class="string">\`\${resource} не найден\`</span>, <span class="string">'NOT_FOUND'</span>, 404)
  }
}
...
<span class="keyword">export class</span> <span class="class-name">RateLimitError</span> <span class="keyword">extends</span> <span class="class-name">AppError</span> {
  <span class="keyword">constructor</span>(retryAfter: <span class="class-name">number</span>) {
    <span class="keyword">super</span>(<span class="string">'Слишком много запросов'</span>, <span class="string">'RATE_LIMIT'</span>, 429, { retryAfter })
  }
}</pre>
                </div>
    ...
    <span class="keyword">try</span> {
      ...
      <span class="keyword">if</span> (error <span class="keyword">instanceof</span> <span class="class-name">ZodError</span>) {
        <span class="keyword">return</span> NextResponse.<span class="function">json</span>(
          {
            error: <span class="string">'Ошибка валидации'</span>,
      ...
      <span class="keyword">return</span> NextResponse.<span class="function">json</span>(
        {
          error: <span class="string">'Внутренняя ошибка сервера'</span>,
        ...
        { status: 500 }
            ...
            <div class="section" id="auth-full">
                <h2 class="section-title">16. Аутентификация (полная реализация)</h2>
...
<span class="keyword">export function</span> <span class="function">useAuth</span>() {
  ...
  <span class="keyword">const</span> loginMutation = <span class="function">useMutation</span>({
    mutationFn: <span class="keyword">async</span> (data: { email: <span class="class-name">string</span>; password: <span class="class-name">string</span> }) => {
      ...
      <span class="keyword">if</span> (result?.error) {
        <span class="keyword">throw new</span> <span class="class-name">Error</span>(<span class="string">'Неверный email или пароль'</span>)
      }

      <span class="keyword">return</span> result
    },
    onSuccess: () => {
      toast.<span class="function">success</span>(<span class="string">'Вы успешно вошли'</span>)
  ...
  <span class="keyword">const</span> registerMutation = <span class="function">useMutation</span>({
    ...
    onSuccess: () => {
      toast.<span class="function">success</span>(<span class="string">'Проверьте почту для подтверждения'</span>)
  ...
  <span class="keyword">const</span> logoutMutation = <span class="function">useMutation</span>({
    ...
    onSuccess: () => {
      toast.<span class="function">success</span>(<span class="string">'Вы вышли из системы'</span>)
  ...
  <span class="keyword">return</span> {
    ...
    isRegisterPending: registerMutation.isPending
            ...
            <div class="section" id="forms-full">
                <h2 class="section-title">17. Формы и валидация</h2>
...
<span class="keyword">export const</span> bookingSchema = z.<span class="function">object</span>({
  ...
  {
    message: <span class="string">'Дата окончания должна быть позже даты начала'</span>,
...
<span class="keyword">export function</span> <span class="function">BookingForm</span>({ itemId, type, onSuccess }: <span class="class-name">BookingFormProps</span>) {
  ...
  <span class="keyword">const</span> mutation = <span class="function">useMutation</span>({
    ...
    onSuccess: (data) => {
      toast.<span class="function">success</span>(<span class="string">'Бронирование создано!'</span>)
      onSuccess?.()
    },
    onError: (error) => {
      toast.<span class="function">error</span>(error.message)
    ...
    &lt;<span class="class-name">Form</span> {...form}&gt;
      &lt;form onSubmit={form.<span class="function">handleSubmit</span>(onSubmit)} className=<span class="string">"space-y-6"</span>&gt;
        &lt;<span class="class-name">FormField</span>
          ...
          render={({ field }) => (
            &lt;<span class="class-name">FormItem</span>&gt;
              &lt;<span class="class-name">FormLabel</span>&gt;Дата заезда&lt;/<span class="class-name">FormLabel</span>&gt;
              &lt;<span class="class-name">FormControl</span>&gt;
        ...
        &lt;<span class="class-name">FormField</span>
          ...
          render={({ field }) => (
            &lt;<span class="class-name">FormItem</span>&gt;
              &lt;<span class="class-name">FormLabel</span>&gt;Дата выезда&lt;/<span class="class-name">FormLabel</span>&gt;
              &lt;<span class="class-name">FormControl</span>&gt;
                &lt;<span class="class-name">DatePicker</span>
                  value={field.value}
                  onChange={field.onChange}
        ...
        &lt;<span class="class-name">FormField</span>
          ...
          render={({ field }) => (
            &lt;<span class="class-name">FormItem</span>&gt;
              &lt;<span class="class-name">FormLabel</span>&gt;Контактный телефон&lt;/<span class="class-name">FormLabel</span>&gt;
              &lt;<span class="class-name">FormControl</span>&gt;
        ...
        &lt;<span class="class-name">FormField</span>
          ...
          render={({ field }) => (
            &lt;<span class="class-name">FormItem</span>&gt;
              &lt;<span class="class-name">FormLabel</span>&gt;Особые пожелания&lt;/<span class="class-name">FormLabel</span>&gt;
              &lt;<span class="class-name">FormControl</span>&gt;
                &lt;<span class="class-name">Textarea</span>
                  placeholder=<span class="string">"Дополнительные пожелания..."</span>
                  {...field}
                /&gt;
              &lt;/<span class="class-name">FormControl</span>&gt;
              &lt;<span class="class-name">FormMessage</span> /&gt;
        ...
        &gt;
          {mutation.isPending ? <span class="string">'Бронирование...'</span> : <span class="string">'Забронировать'</span>}
        &lt;/<span class="class-name">Button</span>&gt;
      &lt;/form&gt;
    &lt;/<span class="class-name">Form</span>&gt;
  )
            ...
            <div class="section" id="file-upload">
                <h2 class="section-title">18. Загрузка файлов</h2>
...
<span class="keyword">export async function</span> <span class="function">POST</span>(request: <span class="class-name">Request</span>) {
  ...
  <span class="keyword">if</span> (!ALLOWED_TYPES.<span class="function">includes</span>(contentType)) {
    <span class="keyword">return</span> NextResponse.<span class="function">json</span>(
      { error: <span class="string">'Недопустимый тип файла'</span> },
      { status: 400 }
    )
  }
  ...
  <span class="keyword">if</span> (contentLength > MAX_SIZE) {
    <span class="keyword">return</span> NextResponse.<span class="function">json</span>(
      { error: <span class="string">'Файл слишком большой (макс. 10MB)'</span> },
      { status: 400 }
    )
  }
...
<span class="keyword">export function</span> <span class="function">ImageUpload</span>({
  ...
  <span class="keyword">const</span> uploadMutation = <span class="function">useMutation</span>({
    mutationFn: <span class="keyword">async</span> (file: <span class="class-name">File</span>) => {
      ...
      <span class="keyword">if</span> (!response.ok) {
        <span class="keyword">throw new</span> <span class="class-name">Error</span>(<span class="string">'Ошибка получения URL'</span>)
      }
    ...
    &gt;
      ...
      {uploadMutation.isPending ? (
        ...
        &lt;div className=<span class="string">"space-y-2"</span>&gt;
          ...
          &lt;p className=<span class="string">"text-sm text-muted-foreground"</span>&gt;
            Макс. размер: 10MB | Форматы: JPEG, PNG, WebP
          &lt;/p&gt;
        &lt;/div&gt;
      )}
    &lt;/div&gt;
            ...
            <div class="section" id="seo">
                <h2 class="section-title">19. SEO оптимизация</h2>
...
<span class="keyword">export async function</span> <span class="function">generateMetadata</span>({
  ...
  <span class="keyword">if</span> (!vehicle) {
    <span class="keyword">return</span> {
      title: <span class="string">'Транспорт не найден'</span>
    }
  }

  <span class="keyword">return</span> {
    title: <span class="string">\`\${vehicle.brand} \${vehicle.model} | Аренда на Пхукете\`</span>,
    description: <span class="string">\`Аренда \${vehicle.type === 'car' ? 'автомобиля' : 'скутера'} \${vehicle.brand} \${vehicle.model} на Пхукете. От \${vehicle.pricePerDay} ฿/день. Бесплатная доставка.\`</span>,
    keywords: [
      <span class="string">'аренда'</span>,
      vehicle.brand,
      vehicle.model,
      <span class="string">'Пхукет'</span>,
      vehicle.type
    ],
    openGraph: {
    ...
    ...tours.<span class="function">map</span>(t => ({
      ...
      priority: 0.8
            ...
            <div class="section" id="performance">
                <h2 class="section-title">20. Оптимизация производительности</h2>
...
module.exports = <span class="function">withBundleAnalyzer</span>(nextConfig)</pre>
            ...
            <div class="section" id="testing">
                <h2 class="section-title">21. Тестирование</h2>
...
<span class="function">describe</span>(<span class="string">'BookingForm'</span>, () => {
  <span class="function">it</span>(<span class="string">'submits booking successfully'</span>, <span class="keyword">async</span> () => {
    ...
    <span class="keyword">await</span> user.<span class="function">type</span>(
      screen.<span class="function">getByLabelText</span>(<span class="string">/контактный телефон/i</span>),
      <span class="string">'+79991234567'</span>
    )

    <span class="comment">// Submit</span>
    <span class="keyword">await</span> user.<span class="function">click</span>(screen.<span class="function">getByRole</span>(<span class="string">'button'</span>, { name: <span class="string">/забронировать/i</span> }))
  ...
  <span class="function">it</span>(<span class="string">'shows validation errors'</span>, <span class="keyword">async</span> () => {
    ...
    <span class="keyword">await</span> <span class="function">waitFor</span>(() => {
      <span class="function">expect</span>(screen.<span class="function">getByText</span>(<span class="string">/обязательное поле/i</span>)).<span class="function">toBeInTheDocument</span>()
    })
  })
  ...
  <span class="function">it</span>(<span class="string">'handles server error'</span>, <span class="keyword">async</span> () => {
    ...
    server.<span class="function">use</span>(
      http.<span class="function">post</span>(<span class="string">'/api/bookings'</span>, () => {
        <span class="keyword">return</span> HttpResponse.<span class="function">json</span>(
          { error: <span class="string">'Это время уже забронировано'</span> },
          { status: 409 }
        )
      })
    )
    ...
    <span class="keyword">await</span> <span class="function">waitFor</span>(() => {
      <span class="function">expect</span>(screen.<span class="function">getByText</span>(<span class="string">/уже забронировано/i</span>)).<span class="function">toBeInTheDocument</span>()
    })
  })
})</pre>
                </div>
...
test.<span class="function">describe</span>(<span class="string">'Booking Flow'</span>, () => {
  ...
  <span class="function">test</span>(<span class="string">'complete vehicle booking flow'</span>, <span class="keyword">async</span> ({ page }) => {
    ...
    <span class="keyword">await</span> page.<span class="function">click</span>(<span class="string">'button:has-text("Забронировать")'</span>)
    ...
    <span class="keyword">await</span> <span class="function">expect</span>(page.<span class="function">locator</span>(<span class="string">'h1'</span>)).<span class="function">toContainText</span>(<span class="string">'Бронирование подтверждено'</span>)
  })
})</pre>
                </div>
            </div>
            ...
            <div class="section" id="deployment">
                <h2 class="section-title">22. Деплой и CI/CD</h2>
...
UPSTASH_REDIS_TOKEN=xxx</pre>
            ...
            <div class="section" id="monitoring">
                <h2 class="section-title">23. Мониторинг</h2>
...
│  ┌────────────────────────────┐    ┌────────────────────────────┐          │
│  │         SENTRY             │    │         POSTHOG            │          │
│  │   • Error tracking         │    │   • User sessions          │          │
│  │   • Performance traces     │    │   • Conversion funnels     │          │
│  │   • Session replays        │    │   • Feature flags          │          │
│  │   • Release tracking       │    │   • A/B testing            │          │
│  └────────────────────────────┘    └────────────────────────────┘          │
│                                                                              │
│  ┌─────────────────────────────────────────────────────────────────────┐    │
│  │                         CUSTOM METRICS                               │    │
...
└─────────────────────────────────────────────────────────────────────────────┘
    ...
    'web-technical': {
        ...
        icon: null,
        platform: 'web',
        breadcrumb: ['Документация', 'Web / Next.js', 'Технический дизайн'],
        description: 'Детали технической реализации Web',
        levels: {
            // ═══════════════════════════════════════════════════════════════════
            // QUICK - Краткая выжимка
            // ═══════════════════════════════════════════════════════════════════
...
STRIPE_WEBHOOK_SECRET=whsec_xxx
    ...
    api: {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Бэкенд', 'API'],
  ...
  "user": {
    ...
    database: {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Бэкенд', 'База данных'],
        description: 'Схема базы данных PostgreSQL',
        content: `
            <div class="section">
                <h2 class="section-title">ER-диаграмма</h2>
                <div class="diagram-block">
                    <pre>
+-------------+       +-------------+       +-------------+
...
CREATE INDEX idx_vehicles_partner ON vehicles(partner_id);
    ...
    comparison: {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Сравнение', 'iOS vs Android'],
        description: 'Сравнение реализаций iOS и Android',
        content: `
            <div class="section">
...
<span class="keyword">class</span> <span class="class-name">HomeViewModel</span> <span class="annotation">@Inject</span> <span class="keyword">constructor</span>(
    ...
    <span class="keyword">var</span> body: <span class="keyword">some</span> <span class="class-name">View</span> {
        <span class="class-name">VStack</span>(alignment: .leading) {
            ...
            <span class="class-name">Text</span>(<span class="string">"฿</span>\(vehicle.priceDay)<span class="string">/day"</span>)
        }
...
<span class="keyword">fun</span> <span class="function">VehicleCard</span>(vehicle: <span class="class-name">Vehicle</span>) {
    <span class="class-name">Card</span>(
        ...
        <span class="class-name">Column</span> {
            ...
            <span class="class-name">Text</span>(text = <span class="string">"฿</span>\${vehicle.priceDay}<span class="string">/day"</span>)
        }
    }
}</pre>
                        </div>
...
+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+
    MVP         v0.4        v0.6        v0.8       v0.9       v1.0-RC    v1.0-BETA    РЕЛИЗ
            ...
            <div class="section">
                <h2 class="section-title">Календарь спринтов</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>20.01 — 02.02</td>
                                <td>Бэкенд</td>
                                <td>API Транспорт и Туры</td>
                            </tr>
                            <tr>
                                <td>Спринт 3</td>
                                <td>03.02 — 16.02</td>
                                <td>Бронирования</td>
                                <td>Система бронирования</td>
                            </tr>
                            <tr>
                                <td>Спринт 4</td>
                                <td>17.02 — 02.03</td>
                                <td>Отзывы</td>
                                <td>Отзывы и рейтинги</td>
                            </tr>
                            <tr>
                                <td>Спринт 5</td>
                                <td>03.03 — 16.03</td>
                                <td>Платежи</td>
                                <td>Интеграция Stripe</td>
                            </tr>
                            <tr>
                                <td>Спринт 6</td>
                                <td>17.03 — 30.03</td>
                            ...
                            <tr>
                                ...
                                <td>31.03 — 13.04</td>
                                <td>Вендоры</td>
                                <td>Панель вендора</td>
                            </tr>
                            <tr>
                                <td>Спринт 8</td>
                                <td>14.04 — 27.04</td>
                                <td>Вендоры</td>
                                <td>Аналитика вендора</td>
                            </tr>
                            <tr>
                                <td>Спринт 9</td>
                                <td>28.04 — 11.05</td>
                                <td>Продвинутое</td>
                                <td>Поиск и фильтры</td>
                            </tr>
                            <tr>
                                <td>Спринт 10</td>
                                <td>12.05 — 25.05</td>
            ...
            <div class="section">
                <h2 class="section-title">Месяц 1: Январь 2026</h2>
                <h3 class="section-subtitle">Базовая инфраструктура бэкенда</h3>
                <p><strong>Цель:</strong> Полноценный бэкенд с работающими API эндпоинтами</p>

                <div class="callout info">
                    <span class="callout-icon">🎯</span>
                    <div class="callout-content">
                        <div class="callout-title">Спринт 1 (06.01 — 19.01): API Жильё</div>
                        <div class="callout-text">Настройка Prisma + PostgreSQL, CRUD для жилья, фильтры, пагинация</div>
                    </div>
                </div>
                ...
                <div class="table-wrapper">
                    <table>
                        ...
                        <tbody>
                            <tr><td>Настройка Prisma + PostgreSQL для прода</td><td>P0</td><td>2д</td></tr>
                            <tr><td>API: GET /properties (список, фильтры, пагинация)</td><td>P0</td><td>3д</td></tr>
                            <tr><td>API: GET /properties/:id (детали)</td><td>P0</td><td>1д</td></tr>
                            <tr><td>API: POST /properties (создание)</td><td>P0</td><td>2д</td></tr>
                            <tr><td>API: PUT/DELETE /properties/:id</td><td>P0</td><td>1д</td></tr>
                            <tr><td>Zod схемы валидации</td><td>P0</td><td>1д</td></tr>
                            <tr><td>Unit-тесты (>70% покрытие)</td><td>P1</td><td>2д</td></tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="callout info">
                    <span class="callout-icon">🎯</span>
                    <div class="callout-content">
                        <div class="callout-title">Спринт 2 (20.01 — 02.02): API Транспорт и Туры</div>
                        <div class="callout-text">Полный CRUD для всех типов каталога, Swagger документация</div>
                    </div>
                </div>

                <p><strong>Результат:</strong> MVP Бэкенд</p>
            </div>

            <div class="section">
                <h2 class="section-title">Месяц 2: Февраль 2026</h2>
                <h3 class="section-subtitle">Система бронирований и отзывов</h3>
                <p><strong>Цель:</strong> Пользователи могут бронировать и оставлять отзывы</p>

                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                                <th>Задачи спринтов 3-4</th>
                                <th>Приоритет</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr><td>CRUD API для бронирований</td><td>P0</td></tr>
                            <tr><td>Проверка доступности дат</td><td>P0</td></tr>
                            <tr><td>Компонент виджета бронирования</td><td>P0</td></tr>
                            <tr><td>Выбор дат с недоступными датами</td><td>P0</td></tr>
                            <tr><td>Страница "Мои бронирования"</td><td>P0</td></tr>
                            <tr><td>CRUD API для отзывов</td><td>P0</td></tr>
                            <tr><td>Бейдж подтверждённого бронирования</td><td>P0</td></tr>
                            <tr><td>Расчёт среднего рейтинга</td><td>P0</td></tr>
                            <tr><td>Загрузка фото к отзывам</td><td>P1</td></tr>
                        </tbody>
                    </table>
                </div>

                <p><strong>Результат:</strong> Система бронирований v0.5</p>
            </div>

            <div class="section">
                <h2 class="section-title">Месяц 3: Март 2026</h2>
                <h3 class="section-subtitle">Платежи и уведомления</h3>
                <p><strong>Цель:</strong> Онлайн-платежи и система уведомлений</p>

                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                                <th>Спринт 5 (Stripe)</th>
                                <th>Спринт 6 (Уведомления)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>Настройка Stripe аккаунта</td>
                                <td>Интеграция Resend</td>
                            </tr>
                            <tr>
                                <td>Создание Checkout Session</td>
                                <td>Email шаблоны (React Email)</td>
                            </tr>
                            <tr>
                                <td>Обработчики Webhook</td>
                                <td>Email подтверждения бронирования</td>
                            </tr>
                            <tr>
                                <td>Обновление статуса платежа</td>
                                <td>Email квитанции об оплате</td>
                            </tr>
                            <tr>
                                <td>Обработка возвратов</td>
                                <td>Напоминание о брони (за 1 день)</td>
                            </tr>
                            <tr>
                                <td>Страницы успеха/отмены</td>
                                <td>In-app уведомления</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

                <p><strong>Результат:</strong> Платёжная система v0.7</p>
            </div>

            <div class="section">
                <h2 class="section-title">Месяц 4: Апрель 2026</h2>
                <h3 class="section-subtitle">Панель вендора</h3>
                <p><strong>Цель:</strong> Вендоры могут управлять своими объявлениями</p>

                <div class="feature-list">
                    <div class="feature-item">
                        <span class="feature-icon">👤</span>
                        <div class="feature-text">
                            <h4>Регистрация вендора</h4>
                            <p>Регистрация с ролью вендора и верификацией</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">📋</span>
                        <div class="feature-text">
                            ...
                            <p>Добавление/Редактирование/Удаление жилья, транспорта, туров</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">📅</span>
                        <div class="feature-text">
                            <h4>Календарь и доступность</h4>
                            <p>Управление доступностью, блокировка дат</p>
                        </div>
                    </div>
                    <div class="feature-item">
                        <span class="feature-icon">📊</span>
                        <div class="feature-text">
                            <h4>Аналитика</h4>
                            <p>Доходы, просмотры, статистика бронирований</p>
                        </div>
                    </div>
                </div>

                <p><strong>Результат:</strong> Панель вендора v0.9</p>
            </div>
            ...
            <div class="section">
                <h2 class="section-title">Риски и Митигация</h2>
                <div class="table-wrapper">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>Задержка одобрения Stripe</td>
                                <td>Средняя</td>
                                <td>Высокое</td>
                                <td>Начать процесс заранее (февраль)</td>
                            </tr>
                            <tr>
                                <td>Проблемы производительности</td>
                                <td>Низкая</td>
                                <td>Среднее</td>
                                <td>Раннее профилирование, кеширование</td>
                            </tr>
                            <tr>
                                <td>Нехватка контента</td>
                                <td>Средняя</td>
                                <td>Среднее</td>
                                <td>Параллельные партнёрства с вендорами</td>
                            </tr>
                            <tr>
                                <td>Баги в продакшне</td>
                                <td>Высокая</td>
                                <td>Высокое</td>
                                <td>Тщательное тестирование, feature flags</td>
                            </tr>
                            <tr>
                                <td>Изменения требований</td>
                                <td>Средняя</td>
                                <td>Среднее</td>
                                <td>Agile подход, еженедельные синки</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    'web-platform': {
        ...
        icon: null,
        platform: null,
        breadcrumb: ['Документация', 'Платформы', 'Web'],
        description: 'PhuketHub Web платформа (Next.js)',
        content: `
            <div class="section">
                <h2 class="section-title">Технологический стек</h2>
